...
"                 Vim. And the time setting is in LINE 399
"            
...
if exists("DoCalltips")
    echo "Loaded already"
    finish
endif

if has("menu")
    amenu &Tools.&Start\ Calltips :call DoCalltips()<CR>
    amenu &Tools.&Stop\ Calltips :call EndCalltips()<CR>
endif

func! DoCalltips()
    if bufexists("Python_Calltips") == 0
